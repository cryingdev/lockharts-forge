                ...
                isSelected 
                    ...
                    : isPipOrder 
                        ...
                        : canCraft
                            ...
                            : 'bg-red-950/25 border-red-900/70 hover:border-red-700/80 hover:bg-red-950/40'
            }`}
        >
            {isPipOrder && (
            ...
            <div className="w-full flex justify-between items-start p-1.5 md:p-2 z-10">
                 <span className={`text-[8px] md:text-[10px] font-bold tracking-wider font-mono ${
                    isSelected ? 'text-amber-400' : canCraft ? 'text-stone-600' : 'text-red-300/80'
                 }`}>T{item.tier}</span>
            ...
            <div className="w-full text-center pb-1.5 px-1 flex flex-col items-center gap-1">
                <div className={`text-[10px] md:text-xs font-bold leading-tight truncate w-full ${
                    isSelected ? 'text-amber-200' : canCraft ? 'text-stone-300' : 'text-red-100/90'
                }`}>
                ...
                <div className="flex items-center gap-1">
                    {inventoryCount > 0 && (
                        <div className="inline-flex items-center gap-0.5 bg-stone-950/60 px-1 md:px-1.5 py-0.5 rounded text-[8px] font-mono text-sky-200 border border-sky-900/40" title="In Storage">
